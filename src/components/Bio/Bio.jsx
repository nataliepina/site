      ...
      <div className='content-wrapper'>
        ...
        <div className='text-wrapper'>
          <p className='text'>
            ...
            resident accessibility advocate.I like to get involved in
            communities such as Google’s Women TechMakers. You can find me
            sharing knowledge writing on FreeCodeCamp. Or sharing CSS and
            JavaScript tips on Twitter. I am also a speaker and open to
            opportunities to share with the community.
          </p>
          <p className='text'>
            If you’d like to get in touch, find me on the internet or say hey
            over an email!
          </p>
